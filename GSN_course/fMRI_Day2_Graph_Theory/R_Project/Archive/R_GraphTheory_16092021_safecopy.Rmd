...
# distribution of ROI-wise clustering at a density threshold of 0.1
...
This is because a node with many connections to his neighbours can also
...
#boxplot(output.data$network.connectivity.within.DMN ~ output.data$DX.Ab)
#
## network decline
#tmp.aov <- aov(data = output.data,
#               network.connectivity.within.DMN ~ DX.Ab + age + sex); summary(tmp.aov); TukeyHSD(tmp.aov, which = "DX.Ab")
#
#
#
## reserve
